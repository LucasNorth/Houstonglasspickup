...
try {
   ...
   if(isset($_GET['Weekly'])){
	...
	echo '<h1> Thank you for your'.$plan.' Subscription ('.$amount.' '.$plan.') and setup one time fee $4.99<br><br></h1>';
	...
	if(isset($_POST['stripeEmail'])){
		...
		$message .= 'Thank you for your'.$plan.' Subscription ('.$amount.' '.$plan.') and setup one time fee $4.99 <br><br>';
		$message .= 'houstonglasspickup.com'.'<br><br>';
		$message .= "</body></html>";
		$subject="Payment Invoice- 9stickers.com";
		$receiver_email="qurbanciit@gmail.com";
